...
public class DesignCircularDeque {
    ...
    public boolean insertFront(int value) {
        ...
        deque[front] = value;
        size++;
        // System.out.println(Arrays.toString(deque) + ", " + size + ", " + front + ", "
        // + end);
        return true;
    }
    ...
    public int getRear() {
        ...
        int lastIndex = (end - 1 + capacity) % capacity;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Insert at front 5: " + deque.insertFront(5)); // Should be true
        System.out.println("Insert at last 6: " + deque.insertLast(6)); // Should be true
